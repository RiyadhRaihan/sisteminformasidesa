...
<body>
                ...
                <div class="card col-12 col-lg-6">
                    <div class="wrapper">
                        ...
                        <p class="mbr-text mb-4 mbr-fonts-style display-4">
                            Halaman ini ditunjukkan bagi RT/RW untuk melakukan input data warga, musrenbang serta surat keterangan, pada halaman ini diwajibkan login</p>
                        <div class="mbr-section-btn"><a class="btn btn-white display-4" href="login/index.php">Login</a></div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <div class="wrapper">
                        <h3 class="mbr-section-title mbr-fonts-style mb-4 display-5"><strong>Pengaduan</strong></h3>
                        ...
                        <div class="mbr-section-btn"><a class="btn btn-white display-4" href="regform/index.php">PENGADUAN</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section style="background-color: #fff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Arial, sans-serif; color:#aaa; font-size:12px; padding: 0; align-items: center; display: flex;"><a href="https://mobirise.site/s" style="flex: 1 1; height: 3rem; padding-left: 1rem;"></a>
        <p style="flex: 0 0 auto; margin:0; padding-right:1rem;">Made with Mobirise - <a href="https://mobirise.site/k" style="color:#aaa;">Try here</a></p>
    </section>
